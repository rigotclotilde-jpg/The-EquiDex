...
import { 
    ...
    ExternalLink, ChevronDown, Quote, Lock
} from 'lucide-react';
...
const PremiumLock: React.FC = () => (
    <div className="relative mt-12 pt-12 pb-20 px-8 bg-gradient-to-b from-transparent via-gray-50/80 to-gray-100 text-center border-t border-gray-100">
        ...
        <div className="relative z-10 max-w-lg mx-auto">
            ...
            <h3 className="text-2xl font-serif font-bold text-slate-900 mb-3">Contenu Réservé aux Membres</h3>
            <p className="text-gray-600 mb-8 text-sm leading-relaxed">
                Accédez à l'analyse détaillée, aux fiches techniques et aux interviews exclusives.
            </p>
            <Link to="/auth">
                <Button className="w-full justify-center py-4 text-sm tracking-widest uppercase font-bold shadow-lg shadow-amber-500/20">
                    Débloquer l'Article Complet
                </Button>
            </Link>
            <p className="text-xs text-gray-400 mt-4">Gratuit pour les membres Éperon d'Or.</p>
        </div>
    </div>
);
        ...
        <div className="bg-white min-h-screen pb-12 font-serif text-slate-900">
            ...
            <div className="container mx-auto px-4 grid grid-cols-1 lg:grid-cols-4 gap-12 max-w-7xl">
                ...
                <article className="lg:col-span-3">
                    ...
                    {/* Intro */}
                    <div className="text-xl text-slate-700 font-light italic mb-12 pl-8 border-l-4 border-amber-600 py-2 leading-relaxed">
                        {article.intro}
                    </div>
