            ...
            <main className="flex-grow p-6 md:p-10">
                ...
                <section className="bg-white p-6 md:p-8 border border-gray-200 shadow-sm mb-8 animate-fade-in">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                        ...
                        <div className="bg-[#FAFAFA] p-6 border border-gray-100 text-center flex flex-col justify-between h-full">
                            <div>
                                <p className="text-xs font-bold text-gray-400 uppercase mb-2">Abonnement</p>
                                <h3 className="text-xl font-serif font-bold text-red-800/60 mb-4 flex items-center justify-center gap-2">
                                    <XCircle size={20} /> Non Abonné
                                </h3>
                            </div>
